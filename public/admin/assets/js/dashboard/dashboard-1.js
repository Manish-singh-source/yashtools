var icChartlist = (function () {
    ...
    var handleWeeklySales = function () {
        ...
        var chart = new ApexCharts(
            document.querySelector("#handleWeeklySales"),
            options
        );
        chart.render();
    };
    ...
    var handleOrderChart = function () {
        ...
        var chartBar1 = new ApexCharts(
            document.querySelector("#handleOrderChart"),
            options
        );
        chartBar1.render();
    };
    ...
    var blanceChart = function () {
        ...
        var chart = new ApexCharts(
            document.querySelector("#blanceChart"),
            options
        );
        chart.render();
    };
    ...
    var handleMarketShare = function () {
        ...
        var chart = new ApexCharts(
            document.querySelector("#handleMarketShare"),
            options
        );
        chart.render();
    };
