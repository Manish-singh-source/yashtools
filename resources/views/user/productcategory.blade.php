...
<?php include 'mainheader.php' ?>
    ...
    <div class="container-fluid">
        <div class="row text-center mhedc">
            <div class="col-lg-3">
                <a href="productcategory.php"><div class="w-100 tagnew1 cth"><i class="fa fa-list"></i>
                Categories</div></a>
            </div>
            <div class="col-lg-3">
                <a href="productbrand.php"><div class="w-100 tagnew1"><i class="fa fa-briefcase"></i>
                 Brand</div></a>
            </div>
            <div class="col-lg-3">
                <a href="#"><div class="w-100 tagnew1"><i class="fa fa-tags"></i>
                 New Products</div></a>
            </div>
            <div class="col-lg-3">
                <a href="#"><div class="w-100 tagnew1"><i class="fa fa-tags"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-sm-6 col-12 mb--30">
                        <div class="axil-product product-style-one">
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    <h5 class="title"><a href="productdetails.php">Part & Mould Identification</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
