                        ...
                        <table class="table axil-product-table axil-cart-table mb--40">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td rowspan="3" class="vlt"><a href="shop.php" class="cartbtn">Enquiry</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="product-thumbnail"><a href="single-product-2.php"><img
                                                src="assets\images\myimg\cart.png" alt="Digital Product"></a></td>
                                    <td class="product-title"><a href="single-product-2.php">Gradient Light
                                            Keyboard</a></td>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="product-thumbnail"><a href="single-product.php"><img
                                                src="assets\images\myimg\cart.png" alt="Digital Product"></a></td>
                                    <td class="product-title"><a href="single-product.php">Wireless PS Handler</a>
                                    </td>
                                    <td class="product-price" data-title="Price">VB1.1/001</td>
                                    <td class="product-quantity" data-title="Qty">
                                        <div class="pro-qty">
