                                ...
                                <div class="accordion">
                                    ...
                                    <div class="accordion-item">
                                        <button id="accordion-button-2" aria-expanded="false"><span
                                                class="accordion-title">How is YASH TOOLS different from other tool suppliers?</span><span class="icon"
                                                aria-hidden="true"></span></button>
                                        <div class="accordion-content">
                                            <p>We go beyond just selling tools—we partner with our clients as part of their team. Our solutions focus on improving productivity, reducing total costs, and enhancing performance through ongoing support, training, and follow-ups.</p>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
