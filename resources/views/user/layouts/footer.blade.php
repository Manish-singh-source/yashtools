                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="axil-footer-widget">
                            ...
                            <div class="inner">
                                <p>Yash Tools (India) Pvt. Ltd., Shop No.2, Louis Palace, Tank Road, Orlem, Malad (West), Mumbai - 400 064. India
                                </p>
                                <ul class="support-list-item">
                                    <li><a href="mailto:nikhil@yashtools.in" contenteditable="false" style="cursor: pointer;"><i class="fal fa-envelope-open"></i>nikhil@yashtools.in</a></li>
                                    <li><a href="tel:+912228631094" contenteditable="false" style="cursor: pointer;"><i class="fal fa-phone-alt"></i>+91-22-2863 1094</a></li>
                        ...
                        <div class="axil-footer-widget">
                            ...
                            <div class="inner">
                                <ul>
                                    ...
                                    <li><div class="form-group mb--0">
                                                <button name="submit" type="submit" id="submit" class="axil-btn btn-bg-primary">Contact Us</button>
                                            </div></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-5 col-lg-12">
                        <div
                            ...
                            <span class="card-text">Designed &amp; Developed By TECHNOFRA</span><p></p>
                        </div>
                    </div>
                </div>
            </div>
