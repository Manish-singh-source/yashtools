                                            ...
                                            <div class="avatar-upload d-flex align-items-center">
                                                <div class="position-relative">
                                                    ...
                                                    <span class="text-danger ms-2 fw-semibold">
                                                        <i class="mdi mdi-ruler-square me-1"></i>Image should be upload in
                                                        300x240px
                                                    </span>
        ...
        $(document).ready(function() {
            ...
            function updateImagePreview($preview, $validation, $imageInfo, $input, valid, width, height, file) {
                ...
                if (valid && width === REQUIRED_WIDTH && height === REQUIRED_HEIGHT) {
                    $validation.html('<i class="mdi mdi-check-circle me-1"></i>✅ Perfect! Ready to upload')
                        .removeClass('text-danger text-info').addClass('text-success fw-semibold');
                    $input.addClass('is-valid').removeClass('is-invalid');
                    $preview.css('border-color', '#28a745');
                } else {
                    $validation.html(
                            `<i class="mdi mdi-close-circle me-1"></i>❌ Wrong size!<br>
                            <small>Required: ${REQUIRED_WIDTH}×${REQUIRED_HEIGHT}px | Got: ${width}×${height}px</small>`
                        )
