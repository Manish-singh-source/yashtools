                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="brand_name"
                                                        ...
                                                        value="{{ old('brand_name', $selectedbrand->brand_name) }}"
                                                ...
                                                <div class="card-body">
                                                    <div class="avatar-upload d-flex align-items-center">
                                                        <div class="position-relative">
                                                            ...
                                                            <div
                                                                class="change-btn d-flex align-items-center flex-wrap mt-2">
                                                                <input type='file'
                                                                    class="form-control d-none @error('brandImage') is-invalid @enderror"
                                                                    name="brandImage" id="imageUpload"
        ...
        $(document).ready(function() {
            ...
            function handleImageUpload(e) {
                ...
                if (!file) {
                    ...
                    $preview.attr('src', "{{ asset('uploads/brands/' . $selectedbrand->brand_image) }}");
            ...
            function validateFileSize(file) {
                if (file.size > 1048576) { // 1MB
                    $('#imageValidation').html('<i class="mdi mdi-alert-circle me-1"></i>File too large (Max 1MB)')
                        .addClass('text-danger');
                    $('#imageUpload').addClass('is-invalid');
                    return false;
                }
