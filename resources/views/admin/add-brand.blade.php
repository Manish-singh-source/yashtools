...
@section('content-body')
    <div class="content-body">
        <div class="container-fluid">
            <!-- Row -->
            <div class="row">
                <form action="{{ route('admin.add.brand') }}" method="POST" enctype="multipart/form-data" id="brandForm">
                    @csrf
                    @method('POST')
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                            ...
                                            <div class="avatar-upload d-flex align-items-center">
                                                <div class="position-relative">
                                                    ...
                                                    <span class="text-danger ms-2 fw-semibold">
                                                        <i class="mdi mdi-ruler-square me-1"></i>Image should be 300x100px
                                                        (Max 1MB)
                                                    </span>
                                ...
                                <button type="submit" class="btn btn-primary btn-sm mt-3" id="submitBtn">
                                    <span class="submit-text">Add Brand</span>
