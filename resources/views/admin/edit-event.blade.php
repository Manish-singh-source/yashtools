...
@section('content-body')
    <div class="content-body">
        <div class="container-fluid">
            <!-- Row -->
            <div class="row">
                <form action="{{ route('admin.update.event') }}" method="POST" enctype="multipart/form-data" id="eventForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-xl-12">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="eventTitle"
                                        ...
                                        value="{{ old('eventTitle', $selectedEvent->events_title) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('eventDescription') is-invalid @enderror" name="eventDescription" rows="4"
                                        placeholder="Enter Event Description" required>{{ old('eventDescription', $selectedEvent->events_description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="eventTag"
                                        class="form-control @error('eventTag') is-invalid @enderror"
                                        value="{{ old('eventTag', $selectedEvent->events_tag) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('eventDate') is-invalid @enderror"
                                        name="eventDate" value="{{ old('eventDate', $selectedEvent->events_date) }}"
                                        required>
                                    @error('eventDate')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <div class="right-sidebar-sticky">
                            <div class="card h-auto">
                                <div class="card-header py-3">
                                    <h4 class="card-title--medium mb-0">Event Image</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="change-btn d-flex align-items-center flex-wrap mt-2">
                                                <input type='file'
                                                    ...
                                                    name="eventImage" id="imageUpload" accept=".png,.jpg,.jpeg,.webp">
                                            ...
                                            <span class="text-danger ms-2 fw-semibold">
                                                <i class="mdi mdi-ruler-square me-1"></i>Image should be 300x280px (Max
                                                3MB)
                                            </span>
                                            <div id="imageValidation" class="ms-3"></div>
                                            <div id="imageInfo" class="mt-2 p-2 bg-light rounded small text-muted d-none">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm mt-3" id="submitBtn">
                            ...
                            <span class="submit-spinner d-none">
                                <i class="mdi mdi-loading spinner"></i> Updating...
                            </span>
                        </button>
                    </div>
                </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            function handleImageUpload(e) {
                ...
                const $label = $('label[for="imageUpload"]');

                // Reset ALL states immediately
                resetImageStates($preview, $validation, $imageInfo, $input);

                if (!file) {
                    // Show original image if no new file selected
                    $preview.attr('src', "{{ asset('uploads/events/' . $selectedEvent->events_image) }}");
                    $label.html('<i class="mdi mdi-camera me-1"></i>Change Image');
                    return;
                }
                ...
                $validation.html('<i class="mdi mdi-loading spinner me-1"></i>Checking dimensions...').addClass(
                    'text-info');
                $label.html('<i class="mdi mdi-loading spinner me-1"></i>Validating...');
            ...
            function resetImageStates($preview, $validation, $imageInfo, $input) {
                ...
                $('label[for="imageUpload"]').html('<i class="mdi mdi-camera me-1"></i>Change Image');
            }
            ...
            function validateFileSize(file) {
                if (file.size > 3145728) { // 3MB
                    $('#imageValidation').html('<i class="mdi mdi-alert-circle me-1"></i>File too large (Max 3MB)')
                        .addClass('text-danger');
                    $('#imageUpload').addClass('is-invalid');
                    return false;
                }
            ...
            function updateImagePreview($preview, $validation, $imageInfo, $input, valid, width, height, file) {
                ...
                if (width === REQUIRED_WIDTH && height === REQUIRED_HEIGHT) {
                    ...
                    $('label[for="imageUpload"]').html('<i class="mdi mdi-check me-1"></i>Perfect Image');
                } else {
                    $validation.html(
