		...
		<div class="login-aside text-center  d-flex flex-column flex-row-auto">
			<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
				<div class="text-center mb-4 pt-5">
					<a href="index-3.php"><img src="assets\images\myimg\logo.png" class="dark-login" alt=""></a>
					<a href="index-3.php"><img src="assets\images\myimg\logo.png" class="light-login" alt=""></a>
				</div>
