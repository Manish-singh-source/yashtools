                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                                ...
                                                <tr class="btn-reveal-trigger">
                                                    <td class="py-2">
                                                        <div class="form-check custom-checkbox checkbox-primary me-3">
                                                            <input type="checkbox"
                                                                ...
                                                                id="customCheckBox2" value="{{ $order->id }}"
                                                                required="">
                                                    ...
                                                    <td class="py-2">
                                                        <a href="{{ route('admin.order.details', $order->enquiry_id) }}"
                                                            class="mark-as-read" data-id="{{ $order->id }}">
                                                        ...
                                                        <div class="dropdown text-sans-serif"><button
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end border py-0"
                                                                ...
                                                                <div class="py-2">
                                                                    ...
                                                                    <input type="hidden" name="currentOrderStatus"
                            ...
                            {{-- Server-side pagination links removed; DataTables handles pagination --}}
                        </div>
                    </div>
                </div>
            </div>
