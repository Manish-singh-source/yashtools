                ...
                <div class="col-xl-12">
                    <div class="row">
                        <form action="{{ route('admin.update.subcategory') }}" method="POST" enctype="multipart/form-data"
                            ...
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="selectedSubcategoryId" value="{{ $selectedSubcategory->id }}">
                            ...
                            <div class="col-xl-12">
                                <div class="card h-auto">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <div
                                                class="dropdown bootstrap-select default-select form-control wide @error('categoryId') is-invalid @enderror">
                                                <select class="default-select form-control wide" name="categoryId" required>
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}"
                                                            {{ old('categoryId', $selectedSubcategory->category_id) == $category->id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="subcategory_name"
                                                ...
                                                value="{{ old('subcategory_name', $selectedSubcategory->sub_category_name) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="display_order"
                                                ...
                                                value="{{ old('display_order', $selectedSubcategory->display_order) }}"
                                ...
                                <button type="submit" class="btn btn-primary btn-sm mt-3" id="submitBtn">
                                    <span class="submit-text">Update Sub Category</span>
        ...
        $(document).ready(function() {
            ...
            function handleImageUpload(e) {
                ...
                if (!file) {
                    ...
                    $preview.attr('src',
                        "{{ asset('uploads/subcategories/' . $selectedSubcategory->sub_category_image) }}");
