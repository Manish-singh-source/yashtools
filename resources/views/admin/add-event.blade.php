                        ...
                        <form action="{{ route('admin.add.event') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-xl-12">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="eventTitle"
                                                ...
                                                value="{{ old('eventTitle') }}" placeholder="Enter Event Title" required>
                                            @error('eventTitle')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('eventDescription') is-invalid @enderror" name="eventDescription" rows="4"
                                                placeholder="Enter Event Description" required>{{ old('eventDescription') }}</textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="eventTag"
                                                ...
                                                value="{{ old('eventTag') }}" placeholder="Enter Event Tag">
                                            @error('eventTag')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <div class="change-btn d-flex align-items-center flex-wrap mt-2">
                                                        <input type='file'
                                                            ...
                                                            name="eventImage" id="imageUpload"
                                                    ...
                                                    <span class="text-danger ms-2 fw-semibold">
                                                        <i class="mdi mdi-ruler-square me-1"></i>Image should be 300x280px
                                                        (Max 3MB)
                                                    </span>
                                ...
                                <button type="submit" class="btn btn-primary btn-sm mt-3" id="submitBtn">
                                    <span class="submit-text">Add Event</span>
