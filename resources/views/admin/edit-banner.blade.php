                        ...
                        <form action="{{ route('admin.update.banner') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-xl-12">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="bannerTitle" value="{{ old('bannerTitle', $banner->banner_title) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('bannerDesciption') is-invalid @enderror" name="bannerDesciption" rows="4"
                                                placeholder="Enter Banner Description">{{ old('bannerDesciption', $banner->banner_description) }}</textarea>
                                                ...
                                                <div class="position-relative">
                                                    ...
                                                    <div class="change-btn d-flex align-items-center flex-wrap mt-2">
                                                        <input type='file'
                                                            ...
                                                            name="banner_image" id="imageUpload"
                                                            accept=".png,.jpg,.jpeg,.webp">
                                                        <label for="imageUpload"
                                                            class="btn btn-sm btn-primary light ms-0 position-relative"
                                                            tabindex="-1">
                                                            <i
                                                                class="mdi mdi-camera me-1"></i>{{ isset($banner->banner_image) && $banner->banner_image ? 'Change Image' : 'Select Image' }}
                                                        </label>
                                ...
                                <button type="submit" class="btn btn-primary btn-sm mt-3" id="submitBtn">
                                    <span class="submit-text">Update Banner</span>
        ...
        $(document).ready(function() {
            ...
            function handleImageUpload(e) {
                ...
                if (!file) {
                    ...
                    $preview.attr('src', "{{ asset('uploads/banner/' . $banner->banner_image) }}");
                    $label.html('<i class="mdi mdi-camera me-1"></i>Select Image');
                    return;
                }
