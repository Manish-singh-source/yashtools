...
<body style="background-color: #f4f4f4; padding: 20px;">
    <div class="container">
        ...
        <div class="content">
            <h3 style="color: #343667;">Client Has Submitted Following Data Through Our Online Feedback Form</h3>
            ...
            <div style="background: #ffc8c5; padding: 15px; border-radius: 5px;">
                ...
                <p><strong>Email ID :</strong> <a href="mailto:{{ $request['email'] }}"
                        style="color: #343667;">{{ $request['email'] }}</a></p>
